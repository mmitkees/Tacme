...
// ---------------------------------------------------------------------
public class NewsDetailsArViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        NewsId {
            public Object get(NewsDetailsArViewRowImpl obj) {
                return obj.getNewsId();
            }

            public void put(NewsDetailsArViewRowImpl obj, Object value) {
        ...
        NewsDetails {
            public Object get(NewsDetailsArViewRowImpl obj) {
                return obj.getNewsDetails();
            }

            public void put(NewsDetailsArViewRowImpl obj, Object value) {
                obj.setNewsDetails((String)value);
            }
        },
        NewsImg {
            public Object get(NewsDetailsArViewRowImpl obj) {
        ...
        public abstract Object get(NewsDetailsArViewRowImpl object);

        public abstract void put(NewsDetailsArViewRowImpl object,
                                 Object value);
    ...
    public static final int NEWSDETAILS = AttributesEnum.NewsDetails.index();
     ...
     */
    public NewsDetailsArViewRowImpl() {
        //        intiateConnection();
    }

    /**
     * Gets NewsDetailsAr entity object.
     * @return the NewsDetailsAr
     */
    public EntityImpl getNewsDetailsAr() {
    ...
    /**
     * Gets the attribute value for NEWS_DETAILS using the alias name NewsDetails.
     * @return the NEWS_DETAILS
     */
    public String getNewsDetails() {
        return (String)getAttributeInternal(NEWSDETAILS);
    }

    /**
     * Sets <code>value</code> as attribute value for NEWS_DETAILS using the alias name NewsDetails.
     * @param value value to set the NEWS_DETAILS
     */
    public void setNewsDetails(String value) {
        setAttributeInternal(NEWSDETAILS, value);
    }
...
//            val.replace("PP-App-rep:16200", "demoserver.tacme.net:12127");
    ...
    /**
     *  Execute the ucm configuration
     */
    public void execute_ucmconfig() {
